...
| [Bedrock generation fanout](bedrock_generation_fanout/) | Tasks that carry a service API request instead of a command to run | You dispatch long-running generation requests from Lambda durable function workers |
