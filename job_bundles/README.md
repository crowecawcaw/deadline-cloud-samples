...
| [Bedrock generation fanout](bedrock_generation_fanout/) | Tasks that describe an Amazon Bedrock API call instead of a command to run | You dispatch long-running service requests from Lambda durable function workers |
